--only the ui with some changes so useless for whoever reads it
--original: https://github.com/IamHrzn/W-Hub/blob/main/UI.lua
...
function Library.Load(LibConfig)
    ...
    LibConfig.Title = shared.Titel or "Title"
